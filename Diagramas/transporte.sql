...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Jun-2019 às 18:56
...
INSERT INTO `rota` (`id`, `inicio`, `fim`, `id_onibus`, `validacao`, `percurso`) VALUES
(1, 'Santa Isabel', 'IF Goiano', 1, 1, 'De la pra ca'),
(2, 'Itapaci', 'UEG', 2, 1, 'De ca pra la');
